...
var CdkDialogContainer = class _CdkDialogContainer extends BasePortalOutlet {
  ...
  _document = inject(DOCUMENT);
  _portalOutlet;
  _focusTrapped = new import_rxjs4.Subject();
  _focusTrap = null;
...
var Dialog = class _Dialog {
  ...
  afterAllClosed = (0, import_rxjs4.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators4.startWith)(void 0)));
  open(componentOrTemplateRef, config) {
    ...
    if (!this.openDialogs.length) {
      ...
      if (dialogContainer._focusTrapped) {
        dialogContainer._focusTrapped.pipe((0, import_operators4.take)(1)).subscribe(() => {
...
var BrnDialogRef = class {
  ...
  dialogId;
  initialOptions;
  _closing = new import_rxjs5.Subject();
  closing$ = this._closing.asObservable();
  _closed = new import_rxjs5.ReplaySubject(1);
  closed$ = this._closed.asObservable();
  _stateChanged = new import_rxjs5.ReplaySubject(1);
...
var BrnDialogService = class _BrnDialogService {
  ...
  _connectDismissalEvents(dialogRef, overlayRef) {
    ...
    overlayRef.outsidePointerEvents().pipe((0, import_operators5.takeUntil)(closed$)).subscribe(() => {
      if (this._isTopmostOutsideTarget(overlayRef)) dialogRef.dismiss("outside");
    });
    overlayRef.backdropClick().pipe((0, import_operators5.takeUntil)(closed$)).subscribe(() => dialogRef.dismiss("backdrop"));
    overlayRef.keydownEvents().pipe((0, import_operators5.filter)((event) => event.key === "Escape"), (0, import_operators5.takeUntil)(closed$)).subscribe((event) => {
...
//# sourceMappingURL=chunk-V3X2P5RX.js.map
